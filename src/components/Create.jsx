      ...
      <div className="col col-xl-6">
        <div className="card card-form" >
          ...
          <form>
            ...
            <h1 className="fw-Bolder mb-3 pb-3 headeing" >Add New Employee</h1>
            </div>
            <br/><br/>
...
<div className="d-flex justify-content-center pt-3">
                    ...
                    <button onClick={sendDataToAPI} type="button" className="btn btn-secondary btn-lg ms-2">Submit</button>
